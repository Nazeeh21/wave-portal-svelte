...
> If you could please change all references to Smart Contract to not be capitalized. You can see here ( https://ethereum.org/en/developers/docs/smart-contracts/ ) That smart contracts shouldn't be capitalized unless the word would otherwise be so.
...
> Can you outline the setting they should choose please. Pictures can aid in the description of something, but should not be the only way to follow the tutorial.
...
> Can you please break down what this code is doing? You can see any QuickNode tutorial as an example of how we like to break down code snippets. you can see this tutorial as an example: https://www.quicknode.com/guides/solidity/how-to-create-and-deploy-an-erc-721-nft Under the "Creating our own token" section.
...
> Can you please fix the alt text for this to be accurate
...
> Again, same deal here. Please break down this code snippet.
...
> Proper alt text here as well please.
...
> I'll only mark it here, but if you could please change all references to Metamask to be capitalized as "MetaMask"
...
> Please break code snippet the above down and explain it.
